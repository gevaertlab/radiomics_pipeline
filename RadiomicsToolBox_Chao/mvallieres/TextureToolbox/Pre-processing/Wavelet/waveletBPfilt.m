...
% Wavelet band-pass filtering. This parameter is denoted as ‘WBPF’. 
%This operation is carried out by applying a different weight to 
%band-pass sub-bands (LHL, LHH, LLH, HLL, HHL and HLH) of the tumour 
%region as compared to low- and high-frequency sub-bands (LLL and HHH) 
%in the wavelet domain. The ratio of the weight applied to band-pass 
%-bands to the weight applied to the other sub-bands is defined by R. 
%Ratios of 1/2, 2/3, 1, 3/2,and 2 were tested.
% -------------------------------------------------------------------------
% OUTPUTS:
