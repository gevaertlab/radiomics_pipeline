...
sData{2}.scan.contour.mask  = []; % proposed by Chao Huang. could be one argument to 'prepareVolume.m'.
...
for contourNumber = 1:nContours
    ...
    sData{2}.scan.contour(contourNumber).mask  = mask; % proposed by Chao Huang. could be one argument to 'prepareVolume.m'.
