...
waitB = 1;
% if waitB
%     waitbarHandle = waitbar(0,'Features extract for LUNG1...','WindowStyle','modal');
% end

% INITIALIZATION

elements=subdir(dicomPath); % list folders and subfolders contents. Copyright 2006 Kelly Kearney
elements=elements([elements.isdir]==0); % delete the fullfile path of directories with an extension of ".nii", proposed by Chao Huang for YangzhouDataSet.
